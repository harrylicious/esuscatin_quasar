...
<script>
  ...
  import { ref } from 'vue'
	...
	export default {
    computed: {
      ...mapGetters('store', ['usersFiltered']),
  ...
  methods: {
    ...
    ...mapActions('store', ['firebaseGetUsersByDatetime']),
  },
  mounted() {
      let bulan = this.$route.params.bulan
	  	this.firebaseGetUsersByDatetime(bulan)
	  },
	}
</script>
